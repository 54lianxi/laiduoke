...
Page({
  ...
  onShow: function() {
    ...
    if(this.data.isPay==false){
      if (null != app.globalData.userInfo && '' != app.globalData.userInfo) {
        ...
        app.checkLogin(app.getUserInfo, this.getSignKey, this);
      }
    ...
    wx.request({
      ...
      success: function(res) {
        if (res.data.retCode == 0) {
          ...
          console.log("signKey" + that.data.signKey);
          //测试时注释校验签名
  ...
  pay: function() {
    ...
    wx.request({
      url: app.globalData.domain + '/scvendor_weixin_user/game/payOrder',
      data: {
